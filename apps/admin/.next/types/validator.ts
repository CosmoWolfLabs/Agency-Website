...
// Validate ../../app/api/tally/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tally">> = Specific
  const handler = {} as typeof import("../../app/api/tally/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
